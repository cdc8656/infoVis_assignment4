...
export default function ScatterPlot(props){
    ...
    useEffect(()=>{
            ...
            const yAxis_spl = d3.axisLeft(yScale).ticks(10); // Creates the y-axis
            ...
            .attr('class', 'y-axis')
            .call(yAxis_spl); //call the yAxis function to create the y-axis

            spl.append("g") //create a group element to hold the y-axis label
            .attr("transform", `translate(${20}, ${height/5})`)
            .append("text")
            .style("text-anchor", "middle")
            .attr("transform", "rotate(-90)") //rotates text to be vertical
